...
object_root = Tk()
object_root.geometry('600x720')
object_root.title('Weather App')  
iconPhoto = PhotoImage(file='Weather app.png')

object_root.iconphoto(False, iconPhoto)  

headingLabel = Label(object_root, text="Welcome To The Weather App", fg='blue', font="poppins 20 bold")
headingLabel.pack()

photo = PhotoImage(file='Weather app.png')
...
def getWeather():
    weatherApiKey = '6ad135629cce41e259aac5b94e034614'
    ...
    footer = Label(object_root, text="TheBrandJonTy.com")
    canvas1.create_window(200, 400, window=footer)
